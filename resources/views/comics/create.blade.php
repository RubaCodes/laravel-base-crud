...
<form class="p-4" action="{{route('comics.store')}}" method="POST">
    ...
    <div class="mb-3">
      ...
      <input name="title" type="text" class="form-control" id="titolo" aria-describedby="emailHelp">
    </div>
    ...
    <div class="mb-3">
        ...
        <input name="series" type="text" class="form-control" id="serie" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
        <label for="tipo" class="form-label">Tipo</label>
        <input name="type"type="text" class="form-control" id="tipo" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
        <label for="thumbnail" class="form-label">Path immagine copertina</label>
        <input name="thumb" type="text" class="form-control" id="thumbnail" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
        <label for="prezzo" class="form-label">Prezzo</label>
        <input class="price" type="number" class="form-control" id="prezzo" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
        <label for="data" class="form-label">Data di uscita</label>
        <input name="sale_date" type="date"  class="form-control" id="data" aria-describedby="emailHelp">
    </div>
